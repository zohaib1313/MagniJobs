...
class UpdateEmployerProfileScreen extends StatefulWidget {
  UpdateEmployerProfileScreen({Key? key}) : super(key: key);
  static const id = "UpdateEmployerProfileScreen";

  @override
  _UpdateEmployerProfileScreenState createState() =>
      _UpdateEmployerProfileScreenState();
}

class _UpdateEmployerProfileScreenState
    extends State<UpdateEmployerProfileScreen> {
  final space = SizedBox(height: 20.h);
  var view = Provider.of<UpdateEmployerProfileViewModel>(myContext!);
